 ...
 *  @param func
 */
case class InnerJoin[L,R,C[_]](left: Sequence[L,C], right: Sequence[R,C], func: BooleanPredicate2) extends
PredicateJoin[L,R,C] {
 ...
 *  @param func
 */
case class OuterJoin[L,R,C[_]](left: Sequence[L,C], right: Sequence[R,C], func: BooleanPredicate2) extends
PredicateJoin[L,R,C] {
