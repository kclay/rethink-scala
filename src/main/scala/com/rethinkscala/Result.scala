...
case class UpdateResult(replaced: Int, unchanged: Int, skipped: Int, errors: Int, @JsonProperty("first_error") firstError: Option[String], deleted: Int, inserted: Int) extends Document
