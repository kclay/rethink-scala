 ...
 *  @param attribute
 */
case class Contains(target: Json, attribute: String) extends ProduceBinary {
 ...
 *  @param attributes
 */
case class Pluck(target: Json, attributes: Iterable[String]) extends ProduceSequence {
 ...
 *  @param attributes
 */
case class Without(target: Json, attributes: Iterable[String]) extends ProduceSequence {
  override lazy val args = buildArgs(target, attributes)
 ...
 *  @param other
 */
case class Merge(target: Json, other: Json) extends ProduceDocument {
 ...
 *  @param diff
 */
case class Difference(target: Json, diff: Iterable[Any]) extends ProduceDocument {
 ...
 *  @param fields
 */
case class HasFields(target: Json, fields: Iterable[String]) extends ProduceBinary {
