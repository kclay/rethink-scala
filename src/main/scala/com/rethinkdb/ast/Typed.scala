...
trait Produce[ResultType] extends Term {
  ...
  def toQuery[R](implicit c: Connection, mf: Manifest[R]): Query[R] = new BlockingQuery[R](this, c,mf)
  ...
  def run[R <: ResultType](implicit c: Connection, mf: Manifest[R]):Either[RethinkError,R] = toQuery.toResult
