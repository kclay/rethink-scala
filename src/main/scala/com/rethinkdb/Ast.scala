...
object Ast {
  ...
  sealed trait BiOpTerm extends Term with Composable with Token

  sealed trait TopLevelTerm extends Term with Composable with Token

  sealed trait MethodTerm extends Term with Composable with Token
